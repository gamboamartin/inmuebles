...
class controlador_inm_conyuge extends _ctl_base {

    public function __construct(PDO      $link, html $html = new \gamboamartin\template_1\html(),
                                stdClass $paths_conf = new stdClass())
    {
        $modelo = new inm_conyuge(link: $link);
        $html_ = new inm_conyuge_html(html: $html);
    ...
    {
        $columns["inm_conyuge_id"]["titulo"] = "Id";
        $columns["inm_conyuge_descripcion"]["titulo"] = "Descripcion";

        $filtro = array("inm_conyuge.id","inm_conyuge.descripcion");

...
class _ubicacion{
    ...
    private function base_view_accion(controlador_inm_ubicacion $controler){
    ...
    final public function base_view_accion_data(controlador_inm_ubicacion $controler, string $funcion){
        ...
        $inm_ubicacion_id = $controler->html->hidden(name:'inm_ubicacion_id',value: $controler->registro_id);
        if(errores::$error){
        ...
        $inputs = (new _keys_selects())->inputs_form_base(btn_action_next: $hiddens->btn_action_next, controler: $controler,
        ...
        $data->base = $base;
        $data->inm_ubicacion_id = $inm_ubicacion_id;

...
class _beneficiario{
    ...
    final public function inputs_beneficiario(controlador_inm_prospecto $controler){
        ...
        $nombre = $controler->html->input_text(cols: 12, disabled: false, name: 'beneficiario[nombre]', place_holder: 'Nombre',
            row_upd: $row_upd, value_vacio: false, class_css: array('beneficiario_nombre'), required: false, value: $row_upd->nombre);
        if(errores::$error){
        ...
        $apellido_paterno = $controler->html->input_text(cols: 6, disabled: false, name: 'beneficiario[apellido_paterno]',
            place_holder: 'Apellido Pat', row_upd: $row_upd, value_vacio: false, class_css: array('beneficiario_apellido_paterno'),
        ...
        $apellido_materno = $controler->html->input_text(cols: 6, disabled: false, name: 'beneficiario[apellido_materno]',
            place_holder: 'Apellido Mat', row_upd: $row_upd, value_vacio: false, class_css: array('beneficiario_apellido_materno'),

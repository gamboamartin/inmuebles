...
class _upd_prospecto_ubicacion{
    ...
    final public function transacciona_conyuge(int $inm_prospecto_ubicacion_id, PDO $link){
        $datos = (new \gamboamartin\inmuebles\controllers\_inm_prospecto_ubicacion())->datos_conyuge(
            link: $link,inm_prospecto_id: $inm_prospecto_ubicacion_id);
        if(errores::$error){

...
class inm_prospecto_proceso extends _modelo_base_paquete {
    public function __construct(PDO $link)
    {
        $tabla = 'inm_prospecto_proceso';
        $columnas = array($tabla=>false,'pr_sub_proceso'=>$tabla,'inm_prospecto'=>$tabla,
            'pr_proceso'=>'pr_sub_proceso');

        $campos_obligatorios = array('pr_sub_proceso_id','inm_prospecto_id','fecha');

        $columnas_extra= array();
        $renombres= array();

        $atributos_criticos = array('pr_sub_proceso_id','inm_prospecto_id','fecha');
    ...
    public function alta_bd(array $keys_integra_ds = array('codigo', 'descripcion')): array|stdClass
    {
        ...
        $valida = $this->valida_init(key_entidad_base_id: 'inm_prospecto_id', key_entidad_id: 'pr_sub_proceso_id',
            registro: $registro);
        if(errores::$error){
        ...
        $registro = $this->init_row(key_entidad_base_id: 'inm_prospecto_id', key_entidad_id: 'pr_sub_proceso_id',
            registro: $registro);
        if(errores::$error){

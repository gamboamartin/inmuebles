...
class inm_rel_co_acred extends _modelo_parent{
    public function __construct(PDO $link)
    {
        $tabla = 'inm_rel_co_acred';
        $columnas = array($tabla=>false,'inm_comprador'=>$tabla,'inm_co_acreditado'=>$tabla);

        $campos_obligatorios = array('inm_comprador_id','inm_co_acreditado_id');

        $columnas_extra= array();

        $renombres = array();

        $atributos_criticos = array('inm_comprador_id','inm_co_acreditado_id');
        ...
        $this->etiqueta = 'Relacion comprador Co acreditado';
    }
    ...
    public function alta_bd(array $keys_integra_ds = array('codigo', 'descripcion')): array|stdClass
    {
        ...
        $filtro['inm_co_acreditado.id'] = $this->registro['inm_co_acreditado_id'];

...
class inm_doc_prospecto_ubicacion extends _modelo_parent
{
    public function __construct(PDO $link)
    {
        $tabla = 'inm_doc_prospecto_ubicacion';
        $columnas = array($tabla => false, 'inm_prospecto_ubicacion' => $tabla, 'doc_documento' => $tabla,
            'doc_tipo_documento' => 'doc_documento', 'doc_extension' => 'doc_documento');

        $campos_obligatorios = array('inm_prospecto_ubicacion_id', 'doc_documento_id');

        $columnas_extra = array();
        $renombres = array();

        $atributos_criticos = array('inm_prospecto_ubicacion_id', 'doc_documento_id');

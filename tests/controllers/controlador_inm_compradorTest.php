...
class controlador_inm_compradorTest extends test {
    ...
    public function test_alta(): void
    {
        ...
        $ch = curl_init("http://localhost/inmuebles/index.php?seccion=inm_comprador&accion=alta&adm_menu_id=64&session_id=4242668692&adm_menu_id=64");
    ...
    public function test_asigna_co_acreditado(): void
    {
        ...
        $ch = curl_init("http://localhost/inmuebles/index.php?seccion=inm_comprador&accion=asigna_co_acreditado&adm_menu_id=64&session_id=4266962270&adm_menu_id=64&registro_id=1");
    ...
    public function test_modifica(): void
    {
        ...
        $ch = curl_init("http://localhost/inmuebles/index.php?seccion=inm_comprador&accion=modifica&adm_menu_id=64&session_id=4242668692&adm_menu_id=64&registro_id=1");

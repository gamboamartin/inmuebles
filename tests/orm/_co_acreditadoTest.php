...
class _co_acreditadoTest extends test {
    ...
    public function test_integra_campo_co_acreditado(): void
    {
        ...
        $registro['z'] = 'FF';
        $resultado = $inm->integra_campo_co_acreditado($campo_co_acreditado, $inm_co_acreditado_ins,
    ...
    public function test_valida_data_co_acreditado(): void
    {
        ...
        $campo_co_acreditado = 'd';
        $registro['z'] = 'FF';
        $resultado = $inm->valida_data_co_acreditado($campo_co_acreditado, $key_co_acreditado, $registro);
        $this->assertIsBool($resultado);
        $this->assertNotTrue(errores::$error);

...
class inm_referenciasTest extends test {
    ...
    public function test_inm_referencias(): void
    {
        errores::$error = false;
        ...
        $inm = new inm_referencia(link: $this->link);
        ...
        $inm_comprador_id = 1;
        $resultado = $inm->inm_referencias($inm_comprador_id);

...
class inm_rel_ubi_compTest extends test {
    ...
    public function test_imp_rel_comprador_com_cliente(): void
    {
        ...
        $inm = new inm_rel_ubi_comp(link: $this->link);
        ...
        $this->assertEquals("Error no existe inm_rel_ubi_comp",$resultado['mensaje_limpio']);
        ...
        $this->assertEquals(1,$resultado['inm_ubicacion_id']);
        errores::$error = false;
    }
